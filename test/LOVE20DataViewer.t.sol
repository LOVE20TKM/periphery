...
contract LOVE20DataViewerTest is Test {
    ...
    function testJoinableActionDetailsWithJoinedInfos() public view {
        (
        ...
        assertEq(
            joinedActions[0].stakedAmount,
            500,
            "stakedAmount should be 500"
        );
        assertEq(
            joinableActionDetails.length,
            3,
            "Should return three JoinableActionDetails"
        );
        assertEq(
            joinableActionDetails[0].action.head.id,
            1,
            "actionId should be 1"
        );
        assertEq(
            joinableActionDetails[0].votesNum,
            100,
            "votesNum should be 100"
        );
        assertEq(
            joinableActionDetails[0].joinedAmount,
            1000,
            "joinedAmount should be 1000"
        );
        assertEq(
            joinableActionDetails[1].action.head.id,
            1,
            "actionId should be 1"
        );
        assertEq(
            joinableActionDetails[1].votesNum,
            100,
            "votesNum should be 100"
        );
        assertEq(
        ...
        assertEq(
            joinableActionDetails[2].action.head.id,
            1,
            "actionId should be 1"
        );
        assertEq(
            joinableActionDetails[2].votesNum,
            100,
            "votesNum should be 100"
        );
        assertEq(
            joinableActionDetails[2].joinedAmount,
            1000,
            "joinedAmount should be 1000"
        );
    }
